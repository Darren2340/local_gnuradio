...
public:
    ...
    QLabel *textLabel1;
    QwtSlider *WaterfallMaximumIntensitySlider;
    QLabel *WaterfallMaximumIntensityLabel;
    QFrame *WaterfallPlotDisplayFrame;
    QwtSlider *WaterfallMinimumIntensitySlider;
    ...
    void setupUi(QWidget *SpectrumDisplayForm)
    {
        ...
        FrequencyPlotDisplayFrame->setMinimumSize(QSize(320, 200));
        ...
        textLabel1->setMaximumSize(QSize(130, 16777215));
        textLabel1->setWordWrap(false);

        gridLayout_3->addWidget(textLabel1, 0, 0, 1, 1);

        WaterfallMaximumIntensitySlider = new QwtSlider(WaterfallPage);
        WaterfallMaximumIntensitySlider->setObjectName(QString::fromUtf8("WaterfallMaximumIntensitySlider"));
        WaterfallMaximumIntensitySlider->setMinimumSize(QSize(50, 0));
        WaterfallMaximumIntensitySlider->setMouseTracking(true);
        WaterfallMaximumIntensitySlider->setFocusPolicy(Qt::ClickFocus);
        WaterfallMaximumIntensitySlider->setValid(true);

        gridLayout_3->addWidget(WaterfallMaximumIntensitySlider, 0, 2, 1, 1);
        ...
        WaterfallPlotDisplayFrame->setMinimumSize(QSize(320, 200));
        ...
        WaterfallMinimumIntensitySlider = new QwtSlider(WaterfallPage);
        WaterfallMinimumIntensitySlider->setObjectName(QString::fromUtf8("WaterfallMinimumIntensitySlider"));
        WaterfallMinimumIntensitySlider->setMinimumSize(QSize(50, 0));
        WaterfallMinimumIntensitySlider->setValid(true);
        WaterfallMinimumIntensitySlider->setMouseTracking(true);
        WaterfallMinimumIntensitySlider->setFocusPolicy(Qt::ClickFocus);

        gridLayout_3->addWidget(WaterfallMinimumIntensitySlider, 2, 2, 1, 1);
        ...
        TimeDomainDisplayFrame->setMinimumSize(QSize(320, 200));
        ...
        ConstellationDisplayFrame->setMinimumSize(QSize(320, 200));
        ...
        QWidget::setTabOrder(FFTSizeComboBox, WaterfallMaximumIntensitySlider);
        QWidget::setTabOrder(WaterfallMaximumIntensitySlider, WaterfallMinimumIntensitySlider);
        ...
        QObject::connect(WaterfallMaximumIntensitySlider, SIGNAL(valueChanged(double)), SpectrumDisplayForm, SLOT(waterfallMaximumIntensityChangedCB(double)));
        QObject::connect(WaterfallMinimumIntensitySlider, SIGNAL(valueChanged(double)), SpectrumDisplayForm, SLOT(waterfallMinimumIntensityChangedCB(double)));
