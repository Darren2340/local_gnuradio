...
sys.path.insert(0, os.path.abspath('/home/darren/repos/local_gnuradio/gnuradio/docs/sphinx'))
sys.path.insert(0, '/home/darren/repos/local_gnuradio_release/lib64/python2.7/site-packages')
...
version = 'v3.7.x-xxx-xunknown'
# The full version, including alpha/beta/rc tags.
release = 'v3.7.x-xxx-xunknown'
