...
class tagged_decoder(object):
    ...
    def make(*args, **kwargs):
        ...
        make(generic_decoder_sptr my_decoder, size_t input_item_size, size_t output_item_size, 
            std::string const & lengthtagname="packet_len") -> tagged_decoder_sptr
...
class tagged_encoder(object):
    ...
    def make(*args, **kwargs):
        ...
        make(generic_encoder_sptr my_encoder, size_t input_item_size, size_t output_item_size, 
            std::string const & lengthtagname="packet_len") -> tagged_encoder_sptr
...
class async_decoder(object):
    ...
    def make(*args, **kwargs):
        """
        make(generic_decoder_sptr my_decoder, bool packed=False, bool rev_pack=True) -> async_decoder_sptr
...
def async_decoder_make(*args, **kwargs):
  """
    async_decoder_make(generic_decoder_sptr my_decoder, bool packed=False, bool rev_pack=True) -> async_decoder_sptr
...
class async_encoder(object):
    ...
    def make(*args, **kwargs):
        """
        make(generic_encoder_sptr my_encoder, bool packed=False, bool rev_unpack=True, bool rev_pack=True) -> async_encoder_sptr
...
def async_encoder_make(*args, **kwargs):
  """
    async_encoder_make(generic_encoder_sptr my_encoder, bool packed=False, bool rev_unpack=True, bool rev_pack=True) -> async_encoder_sptr
...
class ccsds_encoder(generic_encoder):
    ...
    The encoder is set up wtih a number of bits per frame in the constructor. When not being used in a tagged stream mode, this encoder will only process frames of the length provided here. If used in a tagged stream block, this setting becomes the maximum allowable frame size that the block may process.
...
class dummy_encoder(generic_encoder):
    ...
    def make(*args, **kwargs):
        """
        make(int frame_size) -> generic_encoder_sptr
...
def dummy_encoder_make(*args, **kwargs):
  """
    dummy_encoder_make(int frame_size) -> generic_encoder_sptr
...
class async_decoder_sptr(object):
    ...
    def make(self, *args, **kwargs):
        """
        make(async_decoder_sptr self, generic_decoder_sptr my_decoder, bool packed=False, bool rev_pack=True) -> async_decoder_sptr
...
class async_encoder_sptr(object):
    ...
    def make(self, *args, **kwargs):
        """
        make(async_encoder_sptr self, generic_encoder_sptr my_encoder, bool packed=False, bool rev_unpack=True, bool rev_pack=True) -> async_encoder_sptr
