...
class prefs(object):
    ...
    def set_singleton(*args, **kwargs):
        """set_singleton(prefs p)"""
        return _runtime_swig.prefs_set_singleton(*args, **kwargs)
...
def prefs_set_singleton(*args, **kwargs):
  """prefs_set_singleton(prefs p)"""
  return _runtime_swig.prefs_set_singleton(*args, **kwargs)
...
class Instance(object):
    """Proxy of C++ Instance class"""
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def get_application():
        """get_application() -> boost::shared_ptr< ice_application_common >"""
        return _runtime_swig.Instance_get_application()

    get_application = staticmethod(get_application)
    def get_swig_communicator():
        """get_swig_communicator() -> Ice::CommunicatorPtr"""
        return _runtime_swig.Instance_get_swig_communicator()

    get_swig_communicator = staticmethod(get_swig_communicator)
    def __init__(self): 
        """__init__(Instance self) -> Instance"""
        this = _runtime_swig.new_Instance()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _runtime_swig.delete_Instance
    __del__ = lambda self : None;
Instance_swigregister = _runtime_swig.Instance_swigregister
Instance_swigregister(Instance)

def Instance_get_application():
  """Instance_get_application() -> boost::shared_ptr< ice_application_common >"""
  return _runtime_swig.Instance_get_application()

def Instance_get_swig_communicator():
  """Instance_get_swig_communicator() -> Ice::CommunicatorPtr"""
  return _runtime_swig.Instance_get_swig_communicator()
